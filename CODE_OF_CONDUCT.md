...
We as members, contributors, and leaders pledge to make participation in the AxisPy Engine project a harassment-free experience for everyone, regardless of age, body size, visible or invisible disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, religion, or sexual identity and orientation.
...
This Code of Conduct applies within all project spaces (GitHub repository, discussions, issues, pull requests) and also applies when an individual is officially representing the project in public spaces.
